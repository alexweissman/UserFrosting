...
return [ 
    ...
    */
    'site' => [
        ...
        'registration' => [
            'enabled'                    => false, //if this set to false, you probably want to also set require_email_verification to false as well to disable the link on the signup page
            'captcha'                    => false,
    ...
    */
    ...
    'site' => [
        ...
        'title' => 'Football Knockout', // Site display name
